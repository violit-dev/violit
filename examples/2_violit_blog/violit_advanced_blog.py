...
@overload
def db_query(query: str, params: tuple[Any, ...] = (), fetch: Literal[False] = False) -> None:
    ...


@overload
def db_query(query: str, params: tuple[Any, ...] = (), fetch: Literal[True] = True) -> list[dict[str, Any]]:
    ...
