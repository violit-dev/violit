...
class CustomWidgetsMixin:
    def register_widget(
        ...
        *,
        ...
        if widget_name in self._custom_widget_registry:
        ...
        self._custom_widget_registry[widget_name] = definition
    ...
    def widget(self, name: str, *, key: Optional[Any] = None, cls: str = "", style: str = "", **props):
        ...
        definition = self._custom_widget_registry.get(name)
        ...
        cid = (
            ...
            if key is not None
            else self._get_next_cid(f"custom_widget_{_sanitize_custom_widget_key(name)}")
        )
        ...
        for event_name in definition.events:
            ...
            self._register_component(action_cid, action_builder, action=action)
        ...
        def builder():
            ...
            widget_defaults = self._get_widget_defaults(name)
